...
export default async function PaginaCosmeticos() {
  const sql = neon(`${process.env.FRANeon_DATABASE_URL}`);

  // Configurado especificamente para Cosméticos
  const categoriaAlvo = "Cosméticos"; 

  // Busca do banco Neon trazendo as 4 imagens filtradas
    ...
    <div className="w-full bg-zinc-50 min-h-screen pb-20">
      ...
      <section className="max-w-7xl mx-auto px-2 sm:px-4 py-8">
        ...
        {produtos.length === 0 ? (
          ...
          /* Grid corrigido usando 'produto={produto}' em português */
