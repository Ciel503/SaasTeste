...
export default async function FemininoPage() {
  ...
  // 2. Busca APENAS os produtos femininos ordenados pelos mais novos
  ...
  return (
    <div className="w-full bg-zinc-50 min-h-screen pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* VALIDAÇÃO: Se não houver roupas femininas ainda */}
        {produtos.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-xl border p-6 shadow-xs">
            <p className="text-zinc-500 text-sm">Nenhum produto feminino cadastrado ainda.</p>
            <p className="text-xs text-zinc-400 mt-1">Cadastre novas peças femininas no painel /adm!</p>
          </div>
        ) : (
